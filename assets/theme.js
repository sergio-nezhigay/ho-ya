...
var DialogElement = class extends HTMLElement {
  constructor() {
    ...
    this.addEventListener("dialforce-close", (event) => {
      this.hide();
  ...
  show(animate26 = true) {
    ...
    return waitForEvent(this, "dialafter-show");
  }
  /**
  ...
  hide() {
    ...
    return waitForEvent(this, "dialafter-hide");
  }
  /**
    ...
    switch (name) {
      case "open":
        ...
        if (oldValue === null && (newValue === "" || newValue === "immediate")) {
          ...
          this.dispatchEvent(new CustomEvent("dialbefore-show"));
          ...
          animationControls.finished.then(() => {
            this.dispatchEvent(new CustomEvent("dialafter-show"));
          });
          ...
          this.dispatchEvent(new CustomEvent("dialbefore-hide"));
          ...
          hideTransitionPromise.then(() => {
            ...
            this.dispatchEvent(new CustomEvent("dialafter-hide"));
          });
...
var DialogCloseButton = class extends HTMLElement {
  constructor() {
    super();
    this.addEventListener("click", () => this.dispatchEvent(new CustomEvent("dialforce-close", { bubbles: true, cancelable: true, composed: true })));
  }
};
...
var FacetsDrawer = class extends Drawer {
  constructor() {
    ...
    this.addEventListener("dialafter-hide", __privateMethod(this, _FacetsDrawer_instances, updateFacets_fn));
  }
};
...
var QuickBuyModal = class extends Modal {
  constructor() {
    ...
    this.addEventListener("dialafter-hide", __privateMethod(this, _QuickBuyModal_instances, onAfterHide_fn).bind(this));
  }
  async show() {
    document.documentElement.dispatchEvent(new CustomEvent("theme:loading:start", { bubbles: true }));
...
var CartDrawer = class extends Drawer {
  ...
  connectedCallback() {
    ...
    this.addEventListener("dialbefore-show", __privateMethod(this, _CartDrawer_instances, onBeforeShow_fn));
  }
};
...
onBeforeShow_fn = async function() {
  ...
  await waitForEvent(this, "dialafter-show");
...
var HeaderSearch = class extends DialogElement {
  constructor() {
    ...
    this.addEventListener("dialbefore-show", __privateMethod(this, _HeaderSearch_instances, calculateMaxHeight_fn).bind(this));
  }
  get shadowDomTemplate() {
...
var HeaderSidebar = class extends Drawer {
  constructor() {
    ...
    this.addEventListener("dialbefore-show", __privateMethod(this, _HeaderSidebar_instances, onSidebarBeforeShow_fn));
    this.addEventListener("dialafter-show", __privateMethod(this, _HeaderSidebar_instances, onSidebarAfterShow_fn));
    this.addEventListener("dialbefore-hide", __privateMethod(this, _HeaderSidebar_instances, onSidebarBeforeHide_fn));
    this.addEventListener("dialafter-hide", __privateMethod(this, _HeaderSidebar_instances, onSidebarAfterHide_fn));
  }
  connectedCallback() {
    super.connectedCallback();
...
var ShopTheLookMobileCarousel = class extends ScrollCarousel {
  constructor() {
    ...
    Array.from(this.querySelectorAll(".shop-the-look__popover")).forEach((popover) => {
      popover.addEventListener("dialbefore-show", __privateMethod(this, _ShopTheLookMobileCarousel_instances, changeLookFocalPoint_fn).bind(this));
      popover.addEventListener("dialbefore-hide", __privateMethod(this, _ShopTheLookMobileCarousel_instances, restorePosition_fn).bind(this));
    });
  }
  connectedCallback() {
    super.connectedCallback();
